...
?>
  <p>
    ...
    <input id="password" required class="input" type="password" tabindex="30" size="25" value="" name="password" />
    </label>
  </p>
  <p>
    <label for="repeat_password">Repeat password<br/>
    <input id="repeat_password" required class="input" type="password" tabindex="40" size="25" value="" name="repeat_password" />
    </label>
  </p>
<?php
}
...
?>" action="<?php bloginfo("url");?>/wp-login.php" method="post">
    <input type="text" required name="log" placeholder="Kullanıcı Adınız" />
    <input type="password" required name="pwd" placeholder="Şifreniz" />
...
?>" action="<?php bloginfo("url");?>/wp-login.php?action=register" method="post">
    <input type="text" required name="user_login" placeholder="Kullanıcı Adınız" />
    <input type="text" required="email" name="user_email" placeholder="E-posta adresiniz" />
    <input id="password" required type="password" placeholder="Şifreniz" name="password" />
    <input id="repeat_password" required type="password" placeholder="Şifrenizi Tekrar Girin" name="repeat_password" />
...
?>" action="<?php bloginfo("url");?>/wp-login.php" method="post">
    <input type="text" required name="log" placeholder="User Name" />
...
?>" action="<?php bloginfo("url");?>/wp-login.php?action=register" method="post">
    <input type="text" required name="user_login" placeholder="User Name" />
    <input type="text" required="email" name="user_email" placeholder="E-mail address" />
    <input id="password" required type="password" placeholder="Password" name="password" />
    <input id="repeat_password" required type="password" placeholder="Password Again" name="repeat_password" />
...
?>" action="<?php bloginfo("url");?>/wp-login.php" method="post">
 <input type="text" required name="log" placeholder="Nom d'utilisateur" />
    <input type="password" required name="pwd" placeholder="votre mot de passe" />
       <div class="squaredTwo">
  <input type="checkbox"   id="squaredTwo" name="rememberme" />
  <label for="squaredTwo"></label> <div class="Rememberme" style="margin: -16px 38px 7px;
color: rgb(0, 0, 0);
...
?>" action="<?php bloginfo("url");?>/wp-login.php?action=register" method="post">
    <input type="text" required name="user_login" placeholder="Nom d'utilisateur" />
    <input type="text" required="email" name="user_email" placeholder="Adresse e-mails" />
    <input id="password" required type="password" placeholder="Mot de passe" name="password" />
    <input id="repeat_password" required type="password" placeholder="Mot de passe Encore une fois" name="repeat_password" />
